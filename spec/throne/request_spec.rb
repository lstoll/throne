...
describe Throne::Document do
  ...
  shared_examples_for "paramification" do    
    it "should be json encoded" do
      RestClient.should_receive(:get).with("http://127.0.0.1:5984/throne-request-specs/document?startkey=%5B%22abc%22%2C%22xyz%22%5D", {:accept_encoding=>"gzip, deflate"})
      Throne::Request.get :resource => "document", :params => {:startkey => ["abc", "xyz"]}
    end
    
    it "should uri escape each param value" do
      RestClient.should_receive(:get).with("http://127.0.0.1:5984/throne-request-specs/document?descending=true", {:accept_encoding=>"gzip, deflate"})
      Throne::Request.get :resource => "document", :params => {:descending => true}
    end
    
    it "should join using an &" do
      RestClient.should_receive(:get).with("http://127.0.0.1:5984/throne-request-specs/document?descending=true&limit=1", {:accept_encoding=>"gzip, deflate"})
  ...
  describe "get" do
    ...
    it "should get" do
      RestClient.should_receive(:get).with("http://127.0.0.1:5984/throne-request-specs/document", {:accept_encoding=>"gzip, deflate"})
  ...
  describe "delete" do
    ...
    it "should delete" do
      RestClient.should_receive(:delete).with("http://127.0.0.1:5984/throne-request-specs/document", {:accept_encoding=>"gzip, deflate"})
  ...
  describe "put" do
    it "should put" do
      RestClient.should_receive(:put).with("http://127.0.0.1:5984/throne-request-specs/document", "{}", {:accept_encoding=>"gzip, deflate"})
  ...
  describe "post" do
    it "should post" do
      RestClient.should_receive(:post).with("http://127.0.0.1:5984/throne-request-specs/document", "{}", {:accept_encoding=>"gzip, deflate"})
